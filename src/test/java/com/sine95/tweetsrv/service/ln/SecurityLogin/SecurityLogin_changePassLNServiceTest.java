...
public class SecurityLogin_changePassLNServiceTest extends SecurityLoginLNServiceTest
{
	...
	// Inicio tests metodo changePass(login,passOld,passNew)
	...
	*/
	...
	//*****************************************************************************
	//*****************************************************************************
	// Inicio test y funciones auxiliares del metodo changePass(login,passOld,passNew)
	/**
	* Test de SecurityLoginLNService.changePass(login,passOld,passNew)
	...
	*/
	@Test
	@Transactional
	public void testChangePass_DeleteValido()
	{
		Map<String,Object> ctx=new HashMap<String,Object>();
		try {		
			Result< Vacio > res = new Result<>();
			Contexto con=Contexto.init();
			this.preTestChangePass_DeleteValido(ctx);
			...
			//res=serviceLN.changePass( login,passOld,passNew ); 
		...
		{
			postTestChangePass_DeleteValido(ctx);
		}
	}
	/*
	Ayuda: 
	...
	*/
	public Map<String,Object> preTestChangePass_DeleteValido(Map<String,Object> ctx) throws Throwable
	{
	...
	*/
	public void postTestChangePass_DeleteValido(Map<String,Object> ctx)
	{
		try {
	...
	// Fin test y funciones auxiliares del metodo changePass
	...
	*/
	@Test
	@Transactional
	public void testChangePass_DeleteErrorIdNoEncontrado()
	{
		Map<String,Object> ctx=new HashMap<String,Object>();
		try {		
			Result< Vacio > res = new Result<>();
			Contexto con=Contexto.init();
			this.preTestChangePass_DeleteErrorIdNoEncontrado(ctx);
		...
		{
			postTestChangePass_DeleteErrorIdNoEncontrado(ctx);
		}
	}
	/*
	Ayuda: 
	...
	*/
	public Map<String,Object> preTestChangePass_DeleteErrorIdNoEncontrado(Map<String,Object> ctx) throws Throwable
	{
	...
	*/
	public void postTestChangePass_DeleteErrorIdNoEncontrado(Map<String,Object> ctx)
	{
		try {
	...
	// Fin tests metodo changePass(login,passOld,passNew)
