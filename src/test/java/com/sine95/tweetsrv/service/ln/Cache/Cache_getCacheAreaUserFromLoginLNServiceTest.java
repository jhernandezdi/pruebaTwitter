...
public class Cache_getCacheAreaUserFromLoginLNServiceTest extends CacheLNServiceTest
{
	...
	// Inicio tests metodo getCacheAreaUserFromLogin()
	/* Descripcion del metodo:
	* Devuelve la instancia de cache del Area UserFromLogin
	*/
      
	// Fin tests metodo getCacheAreaUserFromLogin()
