...
public class GestionHilos_desactivaTaskLNServiceTest extends GestionHilosLNServiceTest
{
	...
	// Inicio tests metodo desactivaTask(tarea)
	/* Descripcion del metodo:
	* Desactiva para su ejecución la tarea indicada
	*/
      
	// Fin tests metodo desactivaTask(tarea)
