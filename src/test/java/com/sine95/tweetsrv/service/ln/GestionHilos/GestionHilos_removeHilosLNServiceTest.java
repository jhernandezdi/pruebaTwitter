...
public class GestionHilos_removeHilosLNServiceTest extends GestionHilosLNServiceTest
{
	...
	// Inicio tests metodo removeHilos(cola,numHilos)
	...
	*/
	...
	// Fin tests metodo removeHilos(cola,numHilos)
