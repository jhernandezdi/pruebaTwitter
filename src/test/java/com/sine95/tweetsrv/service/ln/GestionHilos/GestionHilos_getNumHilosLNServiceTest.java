...
public class GestionHilos_getNumHilosLNServiceTest extends GestionHilosLNServiceTest
{
	...
	// Inicio tests metodo getNumHilos(cola)
	/* Descripcion del metodo:
	* Devuelve el número de hilos activos en el momento.
	*/
      
	// Fin tests metodo getNumHilos(cola)
