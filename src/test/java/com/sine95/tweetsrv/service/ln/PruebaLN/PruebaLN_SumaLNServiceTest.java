...
public class PruebaLN_SumaLNServiceTest extends PruebaLNLNServiceTest
{
	...
	// Inicio tests metodo Suma(num1,num2)
	...
	*/
	...
	//*****************************************************************************
	//*****************************************************************************
	// Inicio test y funciones auxiliares del metodo Suma(num1,num2)
	/**
	* Test de PruebaLNLNService.Suma(num1,num2)
	...
	*/
	...
	Ayuda: 
		...
		File resource = getFileResourceOfClassMethod(this.getClass(),"Suma2Y2","json");// buca el recurso en el mismo path que la clase, con el nombre <nombreClase>_Suma2Y2.json
		if(!resource.exists())
		{
	...
	*/
	public Map<String,Object> preTestSuma_Suma2Y2(Map<String,Object> ctx) throws Throwable
	{
	...
	*/
	public void postTestSuma_Suma2Y2(Map<String,Object> ctx)
	{
		try {
	...
	// Fin test y funciones auxiliares del metodo Suma
	...
	*/
	@Test
	@Transactional
	public void testSuma_SumaCero()
	{
		Map<String,Object> ctx=new HashMap<String,Object>();
		try {		
			Result< Long > res = new Result<>();
			Contexto con=Contexto.init();
			this.preTestSuma_SumaCero(ctx);
	...
	Ayuda: 
		...
		La forma mas habitual sera la siguiente:
		File resource = getFileResourceOfClassMethod(this.getClass(),"SumaCero","json");// buca el recurso en el mismo path que la clase, con el nombre <nombreClase>_SumaCero.json
		if(!resource.exists())
		{
			fail("Fichero de recursos "+resource.getAbsolutePath()+" no encontrado");
		}
	...
	*/
	public Map<String,Object> preTestSuma_SumaCero(Map<String,Object> ctx) throws Throwable
	{
	...
	*/
	public void postTestSuma_SumaCero(Map<String,Object> ctx)
	{
		try {
	...
	// Fin tests metodo Suma(num1,num2)
