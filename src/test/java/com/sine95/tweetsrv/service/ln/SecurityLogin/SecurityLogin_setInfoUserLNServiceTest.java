...
public class SecurityLogin_setInfoUserLNServiceTest extends SecurityLoginLNServiceTest
{
	...
	// Inicio tests metodo setInfoUser(info)
	/* Descripcion del metodo:
	* Obtenemos los datos que el usuario puede cambiar por sí mismo
	*/
      
	// Fin tests metodo setInfoUser(info)
