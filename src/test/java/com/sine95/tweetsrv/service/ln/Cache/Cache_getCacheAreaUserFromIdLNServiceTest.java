...
public class Cache_getCacheAreaUserFromIdLNServiceTest extends CacheLNServiceTest
{
	...
	// Inicio tests metodo getCacheAreaUserFromId()
	/* Descripcion del metodo:
	* Devuelve la instancia de cache del Area UserFromId
	*/
      
	// Fin tests metodo getCacheAreaUserFromId()
