...
public class Cache_getCacheAreaConfigurationLNServiceTest extends CacheLNServiceTest
{
	...
	// Inicio tests metodo getCacheAreaConfiguration()
	/* Descripcion del metodo:
	* Devuelve la instancia de cache del Area Configuration
	*/
      
	// Fin tests metodo getCacheAreaConfiguration()
