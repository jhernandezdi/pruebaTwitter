...
public class Cache_getCacheAreaCachePruebaLNServiceTest extends CacheLNServiceTest
{
	...
	// Inicio tests metodo getCacheAreaCachePrueba()
	/* Descripcion del metodo:
	* Devuelve la instancia de cache del Area CachePrueba
	*/
      
	// Fin tests metodo getCacheAreaCachePrueba()
