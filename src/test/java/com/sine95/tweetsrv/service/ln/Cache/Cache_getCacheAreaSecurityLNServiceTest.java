...
public class Cache_getCacheAreaSecurityLNServiceTest extends CacheLNServiceTest
{
	...
	// Inicio tests metodo getCacheAreaSecurity()
	/* Descripcion del metodo:
	* Devuelve la instancia de cache del Area Security
	*/
      
	// Fin tests metodo getCacheAreaSecurity()
