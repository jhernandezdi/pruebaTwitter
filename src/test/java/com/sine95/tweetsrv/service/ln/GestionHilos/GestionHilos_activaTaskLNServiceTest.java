...
public class GestionHilos_activaTaskLNServiceTest extends GestionHilosLNServiceTest
{
	...
	// Inicio tests metodo activaTask(tarea)
	/* Descripcion del metodo:
	* Activa para su ejecución la tarea indicada
	*/
      
	// Fin tests metodo activaTask(tarea)
